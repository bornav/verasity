...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_tkl_ansi(
        ...
        KC_ADCAP, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                  KC_ENT,
    ...
    [_FN] = LAYOUT_tkl_ansi(
        ...
        KC_TAB,     KC_LCAP,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_KP_1, KC_KP_2,      KC_KP_3,        KC_NONUS_BSLASH,           KC_F16,  KC_F17, EEPROM_RESET,
        ...
        KC_LCTL,    AG_NORM, KC_LALT,                            KC_SPC,                             KC_RALT, AG_SWAP,      MO(_FN), KC_RCTL,                          KC_LEFT, KC_BRIGHTNESS_DOWN, KC_RGHT
    ),
};
